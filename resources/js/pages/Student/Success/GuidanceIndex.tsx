...
export default function Index() {
    ...
    const downloadImage = async () => {
        ...
        try {
            ...
            link.download = `guidance-${success_data.ref_number}.png`;
            link.href = dataUrl;
            link.click();
        } catch (err) {
        ...
        >
            ...
            <div className="relative z-10 w-full max-w-md rounded-2xl border bg-card p-8 text-card-foreground shadow-lg">
                ...
                <div className="space-y-3">
                    ...
                    <h1 className="text-center text-xl font-semibold">
                        Guidance Form Submitted Successfully
                    </h1>

                    <p className="text-center text-sm text-muted-foreground">
                        You have successfully completed the Guidance form.
                    </p>
                    <p className="text-center text-sm text-muted-foreground">
                        Please take a screenshot or download this confirmation.
                        You will still need your reference number to fill up the
                        Scholarship form.
                    </p>
                </div>
