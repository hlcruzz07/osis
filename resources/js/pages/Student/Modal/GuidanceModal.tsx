...
import { guidance, scholarship } from '@/routes';
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>Open Guidance Form</DialogTitle>
                    <DialogDescription>
                        To proceed with your guidance application, enter the
