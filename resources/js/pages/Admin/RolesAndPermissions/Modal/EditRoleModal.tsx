...
import { createAccount, createRole, updateRole } from '@/routes';
...
export function EditRoleModal({
    ...
    const groupedPermissions = Object.values(
        permissions.reduce((acc: Record<string, any>, perm) => {
            ...
            const group = parts.slice(1).join('_');
        ...
        <Dialog open={open || processing} onOpenChange={setOpen}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Modify the role details and adjust which permissions are
