...
class RoleController extends Controller
{
    ...
    //         ActivityLog::log('delete', 'deleted role with an id of: '. $role->id, Auth::user()->email, request(), 'success');
    ...
    //         ActivityLog::log('delete', 'failed to delete role: ' . $e->getMessage(), Auth::user()->email, request(), 'failed');
